...
test.testForArrays(
  [[1], [2, 3]],
  printTree(new TreeNode(1, new TreeNode(2), new TreeNode(3))),
  1
);
test.testForArrays(
  [[2], [29, 4], [26, 2], [9]],
...
test.test(
  6,
  mps(new TreeNode(1, new TreeNode(2, new TreeNode(-1)), new TreeNode(3))),
  1
);
test.test(
  18,
...
test.test(
  6,
  mps(new TreeNode(1, new TreeNode(-5, new TreeNode(6)), new TreeNode(3))),
  4
);
test.test(
  21,
  mps(
    new TreeNode(
      ...
      new TreeNode(
        ...
        new TreeNode(
          3,
          new TreeNode(5, new TreeNode(13), new TreeNode(-1)),
          new TreeNode(-1)
        )
      ),
      new TreeNode(-5, new TreeNode(-20), new TreeNode(-21))
    )
  ),
  5
);
